...
if __name__ == "__main__":
    ...
    model = InputConvexAutoencoder(input_dim=X.shape[1], hidden_dim=hidden_dim, latent_dim=latent_dim)
    ...
    trained_model, loss_pca_init = train(model, loader, num_epochs=4000, lr=1e-4, device=device)
