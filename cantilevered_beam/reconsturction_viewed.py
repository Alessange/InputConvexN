...
model = InputConvexAutoencoder(input_dim=X_flat.shape[1], hidden_dim=100, latent_dim=30)
model.load_state_dict(torch.load("cantilevered_beam/autoencoder_pca_init_ic.pth", map_location="cpu"))
model.eval()
